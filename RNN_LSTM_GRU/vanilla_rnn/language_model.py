"""Character language model powered by the reference manual Vanilla RNN."""
...
class CharLanguageModel(nn.Module):
    ...
    def forward(
        ...
        """Embed, recur, and project to ``[B, T, vocabulary]``."""
    ...
    def generate(
        ...
        """Autoregressively extend a batch of token prefixes."""
