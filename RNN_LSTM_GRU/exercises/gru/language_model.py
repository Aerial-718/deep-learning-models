"""Rebuild the reference GRU language model from memory."""
...
class CharLanguageModel(nn.Module):
    ...
    def forward(self, token_ids: torch.Tensor, state=None):
        """CORE-G08: embed, recur, and project."""

        raise NotImplementedError("CORE-G08: see gru/prompts.md")
    ...
    def generate(self, prefix: torch.Tensor, new_tokens: int, temperature: float = 1.0,
        ...
        """CORE-G09: generate while carrying hidden state."""

        # Use sample_from_logits inside your autoregressive loop.
        raise NotImplementedError("CORE-G09: see gru/prompts.md")
