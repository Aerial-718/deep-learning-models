"""Character language model powered by the reference manual LSTM."""
...
class CharLanguageModel(nn.Module):
    ...
    def forward(
        ...
        """Embed tokens, apply LSTM, and project every time step."""
    ...
    def generate(
        ...
        """Autoregressively generate while carrying ``(h, c)``."""
